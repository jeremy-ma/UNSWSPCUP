...
trainRecordings = getRecordings('C:\Users\Andrew\Desktop\Unsorted\UNSW Signal Processing Cup\training_data\');
testRecordings = getRecordings('C:\Users\Andrew\Desktop\Unsorted\UNSW Signal Processing Cup\practice_data\');
...
exall = getWeightedEnergyENFExtractorAdd1(5);
ex1 = getWeightedEnergyENFExtractorAdd1SingleHarm(5, 0, 0,1,1);
ex2 = getWeightedEnergyENFExtractorAdd1SingleHarm(5,0,0 ,1,2);
ex3 = getWeightedEnergyENFExtractorAdd1SingleHarm(5,0,0,1,3);
ex4 = getWeightedEnergyENFExtractorAdd1SingleHarm(5,0,0,1,4);

extractors = {extractorFundamental, extractor2, extractor3, extractor4 ...
                e1, e2, e3, e4, exall, ex1,ex2,ex3,ex4};
...
%%
% load ENFSignals.mat
featureExtractors = {@featureMean, @featureLogRange, @featureLogRange...
