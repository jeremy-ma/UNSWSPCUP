...
exall = getWeightedEnergyENFExtractorAdd1(5,0,2^14,1, 150);
ex1 = getWeightedEnergyENFExtractorAdd1SingleHarm(5,0,2^14,1,1);
ex2 = getWeightedEnergyENFExtractorAdd1SingleHarm(5,0,2^14,1,1);
ex3 = getWeightedEnergyENFExtractorAdd1SingleHarm(5,0,2^14,1,1);
ex4 = getWeightedEnergyENFExtractorAdd1SingleHarm(5,0,2^14,1,1);
